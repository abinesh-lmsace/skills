 ...
 * @package skilladdon_skillprogress
 */
class hidecompleted_condition extends condition {
    ...
    public function get_label() {
        ...
        return get_string('hidecompletedskills', 'block_dash');
    }
    ...
    public function get_sql_and_params() {
        ...
        $skills = \tool_skills\helper::get_user_completedskills($userid);

        if (!empty($skills)) {
            list($insql, $inparams) = $DB->get_in_or_equal($skills, SQL_PARAMS_NAMED, 'tskues', false);
            $sql = "tsk.id $insql";
        }
