...
class skills_condition extends condition {
    ...
    public function get_values() {
        ...
        if (isset($this->get_preferences()['enabled']) && $this->get_preferences()['enabled']
            && is_array($this->get_preferences()['skills'])) {
    ...
    public function get_sql_and_params() {
        ...
        list($sql, $inparams) = $DB->get_in_or_equal($skills, SQL_PARAMS_NAMED, 'tskids');

        return ["tsk.id $sql", $inparams];
    }
